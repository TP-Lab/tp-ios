...
- (void)readQRCodeFromAlbumWithCurrentController:(UIViewController *)currentController {
    ...
    if (device) {
        ...
        if (status == PHAuthorizationStatusNotDetermined) { // 用户还没有做出选择
            ...
            UIAlertController *alertC = [UIAlertController alertControllerWithTitle:[[TPOSLocalizedHelper standardHelper] stringWithKey:@"warm_tip"] message:[[TPOSLocalizedHelper standardHelper] stringWithKey:@"album_access_failed"] preferredStyle:(UIAlertControllerStyleAlert)];
