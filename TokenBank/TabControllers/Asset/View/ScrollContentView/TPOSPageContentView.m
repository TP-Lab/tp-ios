...
#import "TPOSPageContentView.h"

#define IOS_VERSION ([[[UIDevice currentDevice] systemVersion] floatValue])
static NSString *collectionCellIdentifier = @"collectionCellIdentifier";

@interface TPOSPageContentView ()<UICollectionViewDelegate,UICollectionViewDataSource>
...
@implementation TPOSPageContentView

- (instancetype)initWithFrame:(CGRect)frame childVCs:(NSArray *)childVCs parentVC:(UIViewController *)parentVC delegate:(id<TPOSPageContentViewDelegate>)delegate
{
...
- (void)scrollViewWillBeginDragging:(UIScrollView *)scrollView
{
    ...
    if (self.delegate && [self.delegate respondsToSelector:@selector(TPOSContentViewWillBeginDragging:)]) {
        [self.delegate TPOSContentViewWillBeginDragging:self];
    }
}
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView
{
    ...
    if (self.delegate && [self.delegate respondsToSelector:@selector(TPOSContentViewDidScroll:startIndex:endIndex:progress:)]) {
        [self.delegate TPOSContentViewDidScroll:self startIndex:startIndex endIndex:endIndex progress:progress];
    }
}
